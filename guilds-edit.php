...
if( isset($_POST['Edit']) ) {
	$conn = connect_db();
		...
		$sql = "UPDATE guilds SET name='". $_POST['name'] ."', shortcut='". $_POST['short'] ."', note='". htmlspecialchars($_POST['note']) ."' WHERE id_guild=". $_POST['id'];
...
$conn = connect_db();
	...
	$sql = "SELECT * FROM guilds WHERE id_guild=". $id;
	$res = mysqli_query($conn, $sql);
...
<p class="web-feature-title-edit w3-center">Edit of Guild No.<?php echo $id; ?></p>
...
<form method="post" action="">
	...
	<b><label clas="fs-1p5vw" for="name">Guild Name: </label></b>
	...
	<br /><br />
	<b><label class="fs-1p5vw" for="short">Guild Shortcut: </label></b>
	<input type="text" class="web-feature-form-element w3-input w3-animate-input w3-transparent w3-text-light-grey w3-center w3-margin-top" placeholder="Fill in the Image Link..." value="<?php echo $set['shortcut']; ?>" name="short" id="short" required />
	</div>
