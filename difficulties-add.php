...
if( isset($_POST['Send']) ) {
	$conn = connect_db();
		...
		$sql = "INSERT INTO `difficulties` (name,img,note) VALUES ('". $_POST['name'] ."', '". $_POST['image'] ."','". htmlspecialchars($_POST['note']) ."')";
...
if ($res) {
	...
	text: "Difficulty has been added without any problem!",
	type: "success",
